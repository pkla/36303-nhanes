...
ggplot(merged, aes(x=RIDAGEYR, y=sleep.hours.weekday)) + geom_point(alpha=0.01) + labs(y="Sleep Hours (Weekdays or Workdays)")
ggplot(merged, aes(x=RIDAGEYR, y=sleep.hours.weekend)) + geom_point(alpha=0.01) + labs(y="Sleep Hours (Weekends)")
```
